...
namespace AmySonicVisualizer.VisualizerControls
{
    public class SpectrumVisualizerControl : BaseVisualizerControl
    {
        ...
        private SolidColorBrush hoverLineBrush; // Brush for active hover tracking
        ...
        {
            base.OnMouseLeave(e);
            OnHoverFrequencyChanged(null); // Clear active hover line globally
        }
        ...
        private void InitDirect2D()
        {
            ...
            // Init the active hover line brush to white, partly transparent
        ...
        private void RenderD2D()
        {
            ...
            // Render the active hover line (mirrored or internal)
            if (Engine != null && Engine.IsLoaded && ActiveHoverFrequency.HasValue && hoverLineBrush != null)
            {
                float hoverX = GetXForFrequency(ActiveHoverFrequency.Value, Width);
